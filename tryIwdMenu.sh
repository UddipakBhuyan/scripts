...
# the list is already sorted why you sort
# there is a error message operation already in progress occuring due to requesting scan while the daemon is doing the auto scan 
# make the password entered dmenu have blac font color and background also black which makes the input private in vision
